...
const sizeClasses = {
  ...
  md: "px-4 py-2 md:px-6 md:py-3 text-sm md:text-base xl:text-xl",
...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    "rounded-full font-medium transition-all flex items-center justify-center gap-1 cursor-pointer duration-300";
